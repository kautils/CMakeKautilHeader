...
macro(git_clone url)
    ...
    set(git_clone.dir_name ${git_clone.dir_name}.cmake)
    set(git_clone.dest "${KAUTIL_THIRD_PARTY_DIR}/kautil_cmake/${git_clone.file_name}")
    if(NOT EXISTS "${git_clone.dest}/${git_clone.dir_name}")
        file(DOWNLOAD ${url} "${git_clone.dest}/${git_clone.dir_name}")
    endif()
    include("${git_clone.dest}/${git_clone.dir_name}")
